    ...
    <footer className="bg-background border-t">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="py-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-lg font-semibold mb-4">ConsultPro</h3>
            <p className="text-muted-foreground text-sm mb-4">
              We connect clients with verified industry experts for personalized consultation services.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/experts" className="text-muted-foreground hover:text-primary">Find an Expert</Link>
              </li>
              <li>
                <Link href="/pricing" className="text-muted-foreground hover:text-primary">Pricing</Link>
              </li>
              <li>
                <Link href="/booking" className="text-muted-foreground hover:text-primary">Book a Session</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm mb-4">
              Subscribe to our newsletter for expert insights and industry news.
            </p>
        ...
        <div className="py-6 border-t text-center sm:flex sm:justify-between sm:text-left text-sm text-muted-foreground">
          <p>© {currentYear} ConsultPro. All rights reserved.</p>
