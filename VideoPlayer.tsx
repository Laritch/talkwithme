...
interface VideoPlayerProps {
  ...
  onComplete?: (sessionId?: string, expertId?: string) => void;
}
...
const VideoPlayer: React.FC<VideoPlayerProps> = ({
  ...
  }, [sessionId, expertId, onProgress, onComplete]);
  ...
  const handleSeek = (e: React.MouseEvent<HTMLDivElement>) => {
    ...
    const seekPosition =
      (e.nativeEvent.offsetX / (e.target as HTMLElement).clientWidth) * duration;
  ...
  return (
    <div className="video-player-container relative bg-muted rounded-lg overflow-hidden shadow-md">
      {/* Video Element */}
      <video
        ref={videoRef}
